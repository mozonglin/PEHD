...
public class PointsRecord {
    ...
    public PointsRecord(String userId, String activityId, String activityName, String activityType, 
                       Integer pointsEarned, String earnedReason, String calculationRule, 
                       Integer participationDuration) {
        this.userId = userId;
