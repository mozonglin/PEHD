...
@Entity
@Table(name = "activity_checkout_codes")
public class ActivityCheckoutCode {
    ...
    // Constructors
    public ActivityCheckoutCode() {}
    
    public ActivityCheckoutCode(String uniqueCode, String activityId, String activityName, 
