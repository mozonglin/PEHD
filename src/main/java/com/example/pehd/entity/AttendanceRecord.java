...
public class AttendanceRecord {
    ...
    public AttendanceRecord(String activityId, String userId, String userName, 
                          String studentId, String checkInLocation, String qrCodeData) {
    ...
    public AttendanceRecord(String activityId, String userId, String userName, 
                          String studentId, String checkInLocation, String checkedInBy, String qrCodeData) {
        this.activityId = activityId;
        this.userId = userId;
        this.userName = userName;
        this.studentId = studentId;
