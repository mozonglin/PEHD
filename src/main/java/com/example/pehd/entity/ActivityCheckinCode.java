...
@Entity
@Table(name = "activity_checkin_codes")
public class ActivityCheckinCode {
    ...
    // Constructors
    public ActivityCheckinCode() {}
    
    public ActivityCheckinCode(String uniqueCode, String activityId, String activityName, 
