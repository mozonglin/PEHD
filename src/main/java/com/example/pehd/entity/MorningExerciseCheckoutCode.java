...
@Entity
@Table(name = "morning_exercise_checkout_codes")
public class MorningExerciseCheckoutCode {
    ...
    // Constructors
    public MorningExerciseCheckoutCode() {}
    
    public MorningExerciseCheckoutCode(String id, String uniqueCode, String exerciseId, 
    ...
    public MorningExerciseCheckoutCode(String uniqueCode, String exerciseId, String exerciseName, 
                                     String studentId, String studentName, Long timestamp, Long expiresAt) {
        this.uniqueCode = uniqueCode;
        this.exerciseId = exerciseId;
        this.exerciseName = exerciseName;
        this.studentId = studentId;
