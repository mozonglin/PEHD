...
public class PrimaryDataSourceConfig {
    ...
    public DataSource primaryDataSource() {
        return DataSourceBuilder.create()
                .url("jdbc:mysql://38.207.179.218:3306/pexitong4?allowPublicKeyRetrieval=true&useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai")
                .username("pexitong3")
                .password("790128mmmm")
